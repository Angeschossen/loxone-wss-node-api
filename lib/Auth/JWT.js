...
JWT.prototype._token_management = function () {
    ...
    const expiresIn = (base_time + (that._token.validUntil * 1000) - (new Date().getTime()) - 600000);
    this.emit('info', `Token expires in ${expiresIn / 1000} second(s)`);
    ...
    setTimeout(
        ...
        }, expiresIn > 2147483647 ? 2147483647 : expiresIn
    );
};
